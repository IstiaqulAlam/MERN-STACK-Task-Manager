                                  ...
                                  ElevatedButton(
                                    onPressed: () async
                                    {
                                      if (firstname.isEmpty ||
                                          ...
                                          email.isEmpty) {
                                        // Throw an error or show a message indicating that all fields must be filled
                                        newMessageText =
                                      ...
                                      if (password.length < 6 || !hasSpecialCharacter(password)){
                                        newMessageText = "Password must be at least 6 characters and\ncontain at least 1 special character.";
                                        changeText();
                                        return;
                                      }
                                        newMessageText = "";
                                      ...
                                      String payload = '{"firstname":"${firstname
                                          ...
                                          .trim()}","email":"${email.trim()}"}';
                                      String? userId = "";
                                      if (password == passwordRepeat) {
                                        try {
                                          String url = 'http://cop4331group2.com:5000/api/register';
                                          print("before payload post");
                                          String ret = await CardsData.postJson(
                                              url, payload);
                                          print("after payload");
                                        }
                                        catch (e) {
